...
async def get_thumb(videoid: str):
    ...
    try:
        ...
        font_path = "ShrutiMusic/assets/font3.ttf"
        ...
        info_font = ImageFont.truetype("ShrutiMusic/assets/font2.ttf", 22)
        draw.text((text_x, info_y), info_text, (200, 200, 200), font=info_font)

        time_font = ImageFont.truetype("ShrutiMusic/assets/font2.ttf", 26)
        ...
        # Watermark
        watermark_font = ImageFont.truetype("ShrutiMusic/assets/font2.ttf", 24)
